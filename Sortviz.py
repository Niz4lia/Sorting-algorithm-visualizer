    ...
    children=[
        dbc.Container(
            [
                ...
                dcc.Store(id="anim-state", data={"playing": False, "speed": 6}),
...
# Clientside Animation Controller (Solves Freezing & Latency completely)
clientside_callback(
    """
    function(n_intervals, steps, theme_key, show_val) {
        ...
        window.animFrame = window.animFrame || 0;
        ...
        if (window.animFrame >= steps.length) {
            ...
            return [
                ...
                String(lastStep.cmp), 
                String(lastStep.swp), 
                "COMPLETE: " + lastStep.cmp + " COMPARISONS, " + lastStep.swp + " SWAPS", 
                true
            ];
        }
        ...
        var nextFrame = window.animFrame + 1;
        window.animFrame = nextFrame;
        var msg = "STEP " + nextFrame + " / " + steps.length;
